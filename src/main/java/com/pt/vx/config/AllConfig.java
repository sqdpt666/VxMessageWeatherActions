...
public class AllConfig {
    public static final String VxAppId = "wx5361d63c9f0d4603";
    public static final String VxAppSecret = "72bd6b348cbf4fb720aaa4711773dcfa";
    public static final String WeatherKey = "高德地图key";
    public static final String WeatherKey_HeFeng = "e5f678c38e074ff5a41f273e9c56be73";
    ...
    private static void init(){
        ...
        userList.add(getUser(
                "ohThG6B5uBRuvXDXw_uBhtER21dg", //扫码关注你的测试号以后，测试平台会出现TA的微信号
                "模板ID", //要给这个人发送的模板ID
                "牛先生", //咋称呼这个人
                "广东省广州市从化区", //这个人的详细地址
                "广州", //这个人在的城市
